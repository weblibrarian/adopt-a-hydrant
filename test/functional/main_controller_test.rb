...
class MainControllerTest < ActionController::TestCase
  ...
  test 'should return the home page' do
    ...
    assert_select 'title', 'Weed Warriors'
    assert_select 'p#tagline', 'Claim responsibility for pulling out invasive species.'
  end
